...
Twitch_Username = 'amrio_bot'  # Twitch.TV username for the bot, must be a registered username!
Twitch_Password = 'oauth:rc9nzxg9g91hcwf15irg3er7ai1opp'  # OAuth for above Twitch.TV account, http://www.twitchapps.com/tmi/
Twitch_Channel = 'zinglax'  # Twitch.TV channel to connect to
